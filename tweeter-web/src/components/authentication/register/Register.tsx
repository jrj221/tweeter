...
const Register = () => {
  ...
  const registerOnEnter = (event: React.KeyboardEvent<HTMLElement>) => {
    if (event.key == "Enter" && !presenterRef.current!.checkSubmitButtonStatus(firstName, lastName, password, alias)) {
  ...
  return (
    <AuthenticationFormLayout
      ...
      submitButtonDisabled={() => presenterRef.current!.checkSubmitButtonStatus(firstName, lastName, password, alias)}
